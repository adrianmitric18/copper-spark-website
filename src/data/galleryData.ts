...
export const categories: GalleryCategory[] = [
  {
    id: "tableaux",
    slug: "tableaux-et-prises",
    label: "Tableaux et prises",
    description: "Installations aux normes RGIE",
    longDescription: "Découvrez nos installations de tableaux électriques conformes aux normes RGIE et nos prises design intégrées. Chaque installation est réalisée avec précision pour garantir sécurité et esthétique.",
  ...
  },
  {
    ...
    longDescription: "Nos solutions d'éclairage LED créent des ambiances uniques pour votre intérieur et extérieur. Des installations professionnelles pour particuliers et professionnels.",
  ...
  },
  {
    ...
    longDescription: "Installation professionnelle de réseaux informatiques, baies de brassage, et systèmes de visiophonie. Solutions de connectivité sur mesure pour particuliers et entreprises.",
  ...
  {
    id: "noel",
    slug: "decoration-de-noel",
    label: "Décoration de Noël",
    description: "Illuminations féeriques",
    longDescription: "Créez une atmosphère magique avec nos installations de décorations lumineuses de Noël. Centres commerciaux, façades, rues et espaces publics : nous illuminons vos fêtes.",
